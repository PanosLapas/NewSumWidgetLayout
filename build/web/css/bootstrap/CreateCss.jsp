<%-- 
    Document   : CreateCss
    Created on : 25 Ιουλ 2013, 3:53:33 μμ
    Author     : plapas
--%>
...
body{margin:0;font-family:"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:14px;line-height:20px;color:#333;background-color: #<%out.print(background);%>}
